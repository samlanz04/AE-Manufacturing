      ...
      <div className="choose-main-cont">
        <div className="choose-cont1">
          ...
          <p>
            ...
            dealership. We redefine your truck-buying experience by ensuring that
        ...
        <div className="choose-cont2">
          <div className="choose-list-cont1">
            ...
            <div>
              <h1>Fair Pricing</h1>
              <p>
                We prioritize transparent and fair truck pricing, aiming to offer
          ...
          <div className="choose-list-cont2">
            ...
            <div>
              ...
              <p>
                ...
                your preferences and guiding you through the truck-buying process
