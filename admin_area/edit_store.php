...
$store_id = $row_store['store_id'];
$store_title = $row_store['store_title'];
$store_image = $row_store['store_image'];  // Use the correct column name
$store_desc = $row_store['store_desc'];
$store_button = $row_store['store_button'];
$store_url = $row_store['store_url'];

$new_s_image = $row_store['store_image'];  // Also update this to match the correct column
...
if(isset($_POST['update'])){
    ...
    $store_title = mysqli_real_escape_string($con, $_POST['store_title']);
    $store_desc = mysqli_real_escape_string($con, $_POST['store_desc']);
    $store_button = mysqli_real_escape_string($con, $_POST['store_button']);
    $store_url = mysqli_real_escape_string($con, $_POST['store_url']);
    ...
    $update_store = "UPDATE store 
                     SET store_title='$store_title', store_image='$store_image', store_desc='$store_desc', 
