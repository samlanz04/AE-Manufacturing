...
$get_p = "select * from trucks where product_id='$edit_id'";
...
$product_img3 = $new_p_image4;
    
}
if(empty($product_img5)){

$product_img3 = $new_p_image5;
        
}
if(empty($product_img6)){

$product_img3 = $new_p_image6;
...
product_img3='$product_img3',product_img='$product_img4',product_img5='$product_img5',product_img6='$product_img6',product_features='$product_features',
product_video='$product_video',product_keywords='$product_keywords',product_label='$product_label',status='$status' where product_id='$p_id'";
