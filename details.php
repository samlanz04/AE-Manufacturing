...
Bundle Price : <del> R$pro_price </del><br>

Bundle sale Price : R$pro_psp_price
...
$run_bundle_product_relation = mysqli_query($db,$get_bundle_product_relation);
