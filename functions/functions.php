          ...
          <div class='col-md-4 col-sm-6 single'>
              <div class='product'>
                  ...
                  <div class='text'>
                      ...
                      <hr>
                      <h3><a href='product_details.php?product_id=$product_id'>$product_title</a></h3>
                      <p class='buttons'>
                          <a href='product_details.php?product_id=$product_id' class='btn btn-default'>View details</a>
                      </p>
                  </div>
...
function getPro3() {
    ...
    // Fetch the latest 10 services from the 'services' table
    $get_services = "SELECT * FROM services ORDER BY service_id DESC LIMIT 4";
    $run_services = mysqli_query($db, $get_services);

    // Loop through each service
    while ($row_services = mysqli_fetch_array($run_services)) {

        // Assign variables to service details
        ...
        // Echo the HTML to display the service details
        echo "
            <div class='col-md-4 col-sm-6 single'>
                <div class='service'>
                    <a href='$service_url'>
                        <img src='admin_area/product_images/$service_image' class='img-responsive'>
                    </a>

                    <div class='text'>
                        <h3><a href='$service_url'>$service_title</a></h3>
...
function getManufacturers() {
    ...
    // Fetch the latest 10 manufacturers from the 'manufacturers' table
    $get_manufacturers = "SELECT * FROM manufacturers ORDER BY manufacturer_id DESC LIMIT 4";
    $run_manufacturers = mysqli_query($db, $get_manufacturers);

    // Loop through each manufacturer
    while ($row_manufacturers = mysqli_fetch_array($run_manufacturers)) {

        // Assign variables to manufacturer details
        ...
        // Echo the HTML to display the manufacturer details
        echo "
            <div class='col-md-4 col-sm-6 single'>
                <div class='manufacturer'>
                    <a href='#'>
                        <img src='admin_area/product_images/$manufacturer_image' class='img-responsive'>
                    </a>
